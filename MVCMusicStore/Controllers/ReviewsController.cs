...
namespace MVCMusicStore.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReivewID,AlbumID,Contents,ReviewerEmail")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReivewID,AlbumID,Contents,ReviewerEmail")] Review review)
        {
            if (ModelState.IsValid)
            {
